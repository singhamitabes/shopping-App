                        ...
                        <div className="p-3 p-lg-5 border">
                            <div className="form-group row">
                                <div className="col-md-12">
                                    ...
                                    <input type="text" className="form-control" id="name" name="name" onChange={getData} placeholder='Enter Product Name' value={data.name}/>
                                </div>
                            </div>
                            <div className="row mb-3">
                                ...
                                <div className="col-lg-3 col-md-6 col-12">
                                    ...
                                    <select name='stock' className='form-control' onChange={getData}>
                                        ...
                                        <option value="Out Of Stock" selected={data.stock==="Out Of Stock"}>Out Of Stock</option>
                                    </select>
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-md-6 col-12">
                                    ...
                                    <input type="text" className="form-control" id="color" name="color" onChange={getData} placeholder='Enter Color Name' value={data.color} />
                                </div>
                                <div className="col-md-6 col-12">
                                    <label htmlFor="size" className="text-black">Size <span className="text-danger">*</span></label>
                                    <input type="text" className="form-control" id="size" name="size" onChange={getData} placeholder='Enter Size Name'  value={data.size}/>
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-md-6 col-12">
                                    <label htmlFor="baseprice" className="text-black">Base Price <span className="text-danger">*</span></label>
                                    <input type="number" className="form-control" id="baseprice" name="baseprice" onChange={getData} placeholder='Enter Base Price' value={data.baseprice} />
                                </div>
                                <div className="col-md-6 col-12">
                                    <label htmlFor="discount" className="number-black">Discount <span className="text-danger">*</span></label>
                                    <input type="number" className="form-control" id="discount" name="discount" onChange={getData} placeholder='Enter Discount'  value={data.discount}/>
                                </div>
                            </div>
                            <div className="mb-3">
